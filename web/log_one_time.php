...
<form action="log_one_time.php" method="post">

          <div class="form-group">
            <div class="form-label-group">
              <input type="text" id="start_time" name="start_time" class="form-control" placeholder="start_time" required="required">
          ...
          <div class="form-group">
            <div class="form-label-group">
              <input type="text" id="finish_time" name="finish_time" class="form-control" placeholder="finish_time" required="required">
